...
const Section8 = () => {
    return (
        <div className="flex-cols mb-20  lg:mt-28 lg:flex-row lg:flex lg:h-[500px] ">

            <div className=" lg:flex lg:px-0 lg:mr-36  lg:ml-10  pt:pt-20  pt:px-32 max-pt:py-10 lg:h-[500px] lg:w-[400px] lg:pt-0 lg:pl-0">
            ...
            <div className="flex-col max-lg:ml-10 lg:flex-1 h-auto w-screen pt:h-[470px] md:h-[550px] lg:h-[500px] ">
                <div>
                <Carousel3 className="object-cover w-full pt:h-[470px] md:h-[550px] lg:h-[500px]"/> </div>
                <div className='text-left text-lg pt-3'>Aesop MOKO</div>
            </div>
